// let buffer = Buffer.from('六六'); // buffer 是内存 截取出来的就是内存地址
...
let buffer1 = Buffer.from('朱'); // 0-5
console.log(buffer1); //<Buffer e6 9c b1> utf-8 朱的编码就是 e6 9c b1
let buffer2 = Buffer.from('五五');
